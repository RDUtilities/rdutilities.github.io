  ...
  products: [
    ...
    },
    {
      ...
      actions: [
        { label: "View Details", href: "./logsupertool.html" },
        {
          ...
          href: "https://github.com/RDUtilities/Downloads/releases/download/logsupertool-v1.1.0/LogSuperTool-v1.1.0-win-x64.zip"
        },
        {
    ...
    },
    {
      ...
      actions: [
        ...
        {
          label: "Download v1.2",
          href: "https://github.com/RDUtilities/Downloads/releases/download/speakshot-v1.2/SpeakShot-v1.2.zip"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      actions: [
        { label: "View Details", href: "./winget-supertool.html" },
        {
          ...
          href: "https://github.com/RDUtilities/Downloads/releases/download/winget-super-tool-v1.2.0/WinGetSuperTool.zip"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      actions: [
        ...
        {
          label: "Download v3.3",
          href: "https://github.com/RDUtilities/DollarsAndSense/releases/download/v3.3-ai-model-refresh/DollarsAndSense-v3.3-ai-model-refresh-macOS.zip"
        }
      ]
    },
    {
